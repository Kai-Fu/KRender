...
int TriIntersectBBox(const KAccleTriVertPos& tri, const KBBox& bbox)
{
...
// [Kai] Thank Tomas for his code, I did a minor adjustment on the input parameters.
/********************************************************/
